...
const Projects = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                ...
                if (projectsResponse.data && Array.isArray(projectsResponse.data.items)) {
                ...
                if (err.response && err.response.status === 422) {
                    setError('Ошибка валидации данных с сервера. Пожалуйста, проверьте введенные данные.');
                } else {
    ...
    //         // Если категория уже выбрана, снимаем фильтр
    //         setSelectedCategory(null);
    //         setFilteredProjects(projects); // Сбрасываем фильтрацию
    //     } else {
